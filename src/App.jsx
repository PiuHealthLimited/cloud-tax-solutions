  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/Restaurant_franchise_accounting" element={<Restaurant_franchise_accounting />} />
        ...
        <Route path="/Business_startup_and_incorporation" element={<Business_startup_and_incorporation />} />
