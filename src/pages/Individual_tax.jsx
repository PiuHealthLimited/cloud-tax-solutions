        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-6 wow fadeInLeft">
              <img
                src="images/IndividualTax/Image1.1.png"
          ...
          <div className="row flex-row-reverse">
            <div className="col-md-6">
              <div className="tips-img wow fadeIn animated bounce slower">
                <img src="images/IndividualTax/Image1.2.png" className="img-fluid" alt="" />
              </div>
            </div>
      ...
      <section className="service-section">
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-6 wow fadeInLeft">
              <img
                src="images/IndividualTax/Image1.3.jpg"
                className="img-fluid pr-5"
                data-jarallax='{"speed": 0.6}'
                alt="About Details"
              />
            ...
            <div className="col-lg-6 col-md-6 text-left align-self-center">
              <div className="iq_wrapper_column">
                <h2 className="font-weight-bold">Our Individual Tax Services Include:</h2>
                <ul className="list-unstyled mt-4">
                  ...
                  <li className="mb-2 d-flex">
                    <span className="me-2">•</span>
                    <span>
                      <strong>Income tax services for students</strong>
                    </span>
                  </li>
                  <li className="mb-2 d-flex">
                    <span className="me-2">•</span>
                  ...
                  <li className="mb-2 d-flex">
                    <span className="me-2">•</span>
                    <span>
                      <strong>Tax return preparation for deceased individuals.</strong>
                    </span>
                  </li>
                  <li className="mb-2 d-flex">
                    <span className="me-2">•</span>
                    <span>
                      <strong>Income tax services for non-residents.</strong>
                    </span>
                  </li>
                  <li className="mb-2 d-flex">
                    <span className="me-2">•</span>
                  ...
                  <li className="mb-2 d-flex">
                    <span className="me-2">•</span>
                    <span>
                      <strong>Voluntary Tax Disclosure and Tax Appeals.</strong>
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="service-section">
        <div className="container">
          <div className="row flex-row-reverse">
            <div className="col-md-6">
              <div className="tips-img wow fadeIn animated bounce slower">
                <img src="images/IndividualTax/Image1.4.png" className="img-fluid" alt="" />
              </div>
            </div>
            <div className="col-md-6 text-left align-self-center">
              <div className="ml-3 mt-3">
      ...
      <section className="service-section">
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-6 wow fadeInLeft">
              <img
                src="images/IndividualTax/Image1.5.png"
                className="img-fluid pr-5"
                data-jarallax='{"speed": 0.6}'
                alt="About Details"
              />
